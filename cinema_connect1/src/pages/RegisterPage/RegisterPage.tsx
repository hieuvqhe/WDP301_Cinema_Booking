        ...
        <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex justify-between mb-2">
              <div className="flex items-center">
                <div className={`flex items-center justify-center w-8 h-8 rounded-full ${currentStep === 0 ? 'bg-orange-500' : 'bg-gray-600'} text-white`}>
                  1
                </div>
              ...
              <div className="flex items-center">
                <div className={`flex items-center justify-center w-8 h-8 rounded-full ${currentStep === 1 ? 'bg-orange-500' : 'bg-gray-600'} text-white`}>
                  2
                </div>
                ...
                <div>
                  ...
                  <div className="relative mt-1">
                    ...
                    <input
                      ...
                      className={`pl-10 block w-full px-3 py-2 border ${errors.name ? 'border-red-500' : 'border-gray-600'} bg-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-orange-500 focus:border-orange-500 text-white`}
                ...
                <div>
                  ...
                  <div className="relative mt-1">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={`pl-10 block w-full px-3 py-2 border ${errors.confirm_password ? 'border-red-500' : 'border-gray-600'} bg-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-orange-500 focus:border-orange-500 text-white`}
                ...
                <div>
                  ...
                  <div className="mt-1">
                    <input
                      ...
                      onChange={handleChange}
                      className={`block w-full px-3 py-2 border ${errors['date_of_birth'] ? 'border-red-500' : 'border-gray-600'} bg-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-orange-500 focus:border-orange-500 text-white`}
                    />
                  </div>
                ...
                <div>
                  ...
                  <div className="relative mt-1">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={`pl-10 block w-full px-3 py-2 border ${errors.phone ? 'border-red-500' : 'border-gray-600'} bg-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-orange-500 focus:border-orange-500 text-white`}
                ...
                <div>
                  ...
                  <div className="relative mt-1">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={`pl-10 block w-full px-3 py-2 border ${errors['address.street'] ? 'border-red-500' : 'border-gray-600'} bg-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-orange-500 focus:border-orange-500 text-white`}
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={`mt-1 block w-full px-3 py-2 border ${errors['address.city'] ? 'border-red-500' : 'border-gray-600'} bg-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-orange-500 focus:border-orange-500 text-white`}
                      placeholder="City"
                    />
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={`mt-1 block w-full px-3 py-2 border ${errors['address.country'] ? 'border-red-500' : 'border-gray-600'} bg-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-orange-500 focus:border-orange-500 text-white`}
                      placeholder="Country"
                    />
